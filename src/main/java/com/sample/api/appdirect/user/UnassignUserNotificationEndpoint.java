...
@RestController
@RequestMapping("api/notification/user/unassignment")
public class UnassignUserNotificationEndpoint extends AbstractUserEndpoint {

    @Resource(name = "unassignUserNotificationHandler")
    ...
    public Response create(@RequestParam("url") final String url) {
        return process(url, EventType.USER_UNASSIGNMENT);
    }
