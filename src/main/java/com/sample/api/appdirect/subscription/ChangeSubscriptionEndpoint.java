...
@RestController
@RequestMapping("api/notification/subscription/change")
public class ChangeSubscriptionEndpoint extends AbstractSubscriptionEndpoint {

    @Resource(name = "changeSubscriptionNotificationHandler")
    ...
    public Response create(@RequestParam("url") final String url) {
        return process(url, EventType.SUBSCRIPTION_CHANGE);
    }
