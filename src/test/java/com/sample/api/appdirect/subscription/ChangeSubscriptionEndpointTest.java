...
public class ChangeSubscriptionEndpointTest extends AbstractSubscriptionEndpointTest {

    private static final String ENDPOINT_PATH = "/api/notification/subscription/change";

    @Test
    public void changeSubscriptionSuccessfully() throws Exception {
    ...
    protected AbstractSubscriptionEndpoint createNotificationHandler() {
        final ChangeSubscriptionEndpoint endpoint = new ChangeSubscriptionEndpoint();
    ...
    protected EventType getEventType() {
        return EventType.SUBSCRIPTION_CHANGE;
    }
}
